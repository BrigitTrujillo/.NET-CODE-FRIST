...
namespace Lab11.Controllers
{
    public class DetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DetailId,Price,SubTotal,ProductId,InvoiceId")] Detail detail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DetailId,Price,SubTotal,ProductId,InvoiceId")] Detail detail)
        {
