...
namespace Lab11.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var demoContext = _context.Invoices.Include(i => i.Customer);
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,Date,InvoiceNumber,Total,CustomerId")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,Date,InvoiceNumber,Total,CustomerId")] Invoice invoice)
        {
